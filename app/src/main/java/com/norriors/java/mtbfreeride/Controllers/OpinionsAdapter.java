...
public OpinionsAdapter(Activity context, List<Opinions> objects) {
...
public View getView(int position, View convertView, ViewGroup parent){
        ...
        if(element == null) {
        opinionsAdapter = new OpinionsAdapter(context,dades);
        ...
        opinionsAdapter = (OpinionsAdapter)element.getTag();
        }
    ...
    opinionsAdapter.txtVisites.setText("Num. visites: " + opinions.getTotal());
    opinionsAdapter.txtVisites.setTypeface(font);
