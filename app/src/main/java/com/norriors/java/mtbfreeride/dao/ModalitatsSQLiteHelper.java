...
public class ModalitatsSQLiteHelper extends SQLiteOpenHelper {
    ...
    public void executaInsertsModalitas(SQLiteDatabase db) {
        ...
        insertModalitats.bindString(5, "https://onedrive.live.com/download?resid=ad8928a740ca42a%215479");
        insertModalitats.executeInsert();
        ...
        insertModalitats.bindString(5, "https://onedrive.live.com/download?resid=ad8928a740ca42a%215465");
        insertModalitats.executeInsert();
